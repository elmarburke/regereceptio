...
factory('pouchClient', ["$rootScope", "$q", "safeApply", "logger", "pouchDatabase", function($rootScope,$q,safeApply,logger,pouchDatabase) {
    ...
    .factory('pouchDatabase', ['$rootScope','$q','safeApply','logger', function($rootScope,$q,safeApply,logger) {
        ...
        return function(name, options){
            ...
            pouchDatabase.replicate = {
              to: function (remoteDB, options) {
                ...
                options.complete = basicDeferredCallback(deferred, 'replicate_from');
                
                pouchDatabase._database.replicate.to(remoteDB, options);
                return deferred.promise;
              },
              from: function (remoteDB, options) {
                ...
                pouchDatabase._database.replicate.from(remoteDB, options);
                return deferred.promise;
              }
            };
